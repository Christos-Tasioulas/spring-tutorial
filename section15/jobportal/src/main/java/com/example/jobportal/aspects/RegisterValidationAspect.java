package com.example.jobportal.aspects;

import com.example.jobportal.dto.RegisterRequestDTO;
import com.example.jobportal.entity.JobPortalUser;
import com.example.jobportal.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* com.example.jobportal.auth.AuthController
        .registerUser(..))
        """)
