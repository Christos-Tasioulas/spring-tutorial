...
public class UserController {
    ...
    public String searchUserOrderWithMultiPathValues(@PathVariable(name="userId") Long customerId, @PathVariable(required = false) Long orderId) {
        return "Fetched user with id: " + customerId + " and order id: " + orderId;
    }

    @GetMapping({"/{userId}/address/{addressId}"})
    public String searchUserAddressWithMultiPathValues(@PathVariable Map<String, String> pathVariablesMap) {
    ...
    public String createUser(@RequestBody UserDto userDto) {
        return "Created user with data: " + userDto.toString();
    }
